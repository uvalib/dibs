      ...
      <div class="container-fluid main-container">
        ...
        <div class="row d-flex justify-content-center">
          <div class="loan-info mt-5 px-3">
            ...
            <p class="copyright"><strong>Copyright Notice:</strong> The copyright law of the United States (title 17, United States Code) governs the making of photocopies or other reproductions of copyrighted material. Under certain conditions specified in the law, libraries and archives are authorized to furnish a photocopy or other reproduction. One of these specific conditions is that the photocopy or reproduction is not to be “used for any purpose other than private study, scholarship, or research.” The library has utilized technical measures to prevent any further copying, downloading, or distribution of this work. Use of this reproduction in violation of these terms could subject users to potential liability for copyright infringement.</p>
