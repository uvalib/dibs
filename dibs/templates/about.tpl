...
<html lang="en">
  ...
  <head>
    ...
    <title>UVA Library e reserves</title>
  </head>
  ...
  <body>
    <div class="page-content">
      ...
      <div class="container main-container">
        ...
        <p class="my-3"><strong>UVA Library DIBS</strong> (<em><strong>Di</strong>gital <strong>B</strong>orrowing <strong>S</strong>ystem</em>) is an implementation of <a target="_blank" href="https://vivalib.org/va/cdl">Virginia's Academic Library Consortium (VIVA)'s Controlled Digital Lending method</a>, allowing UVA borrowers to access course reserve materials that are not otherwise available in e-book or other electronic formats. Access to materials in UVA Library DIBS is limited to current UVA faculty, students and staff enrolled in academic courses. The system was implemented in the year 2021 to help Caltech students and faculty during the global <a target="_blank" href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019">COVID-19 pandemic</a> and is being piloted as of August 2022 by UVA Library.</p>
        ...
        <div align="center" class="mx-auto text-center">
          ...
          <p><img src="{{base_url}}/static/megaphone.svg" class="svg-megaphone"> Send feedback by email to <a href="mailto:lib-reserves@virginia.edu">lib-reserves@virginia.edu</a> or the <a href="{{feedback_url}}">web form</a>.</p>
        </div>
